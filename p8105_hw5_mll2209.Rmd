...
From the spaghetti plot, it seems that over time, the control group has lower observations when compared to the experimental group. 
...
Make plot showing average estimate of mu hat and true mu. Make second plot with average estimate of mu hat for which the null was rejected and the true value of mu
```{r}
plot1 = 
  sim_results1 %>%
  mutate(
